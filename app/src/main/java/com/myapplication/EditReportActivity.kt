...
class EditReportActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSubmit.setOnClickListener {
            if (selectedImageUri != null) {
                uploadImageAndUpdateReport()
            } else {
                updateReportToFirestore(previousImageUrl ?: "")
            }
        }
    ...
    private fun loadReportData(id: String) {
        ...
        FirebaseFirestore.getInstance().collection("reports").document(id)
            ...
            .addOnSuccessListener { doc ->
                ...
                if (report != null) {
                    currentLatLng = LatLng(report.latitude ?: 0.0, report.longitude ?: 0.0) // ← Pindah ke sini
                    titleInput.setText(report.title)
                    descInput.setText(report.description)
                    ...
                    // Kategori
                    val index = (categorySpinner.adapter as ArrayAdapter<String>)
                        .getPosition(report.category)
                    categorySpinner.setSelection(index)
                    selectedCategory = report.category

                    // Simpan image lama kalau tidak ganti
                    selectedImageUri = null
                    previousImageUrl = report.imageUrl
                }
            }
    ...
    private fun uploadImageAndUpdateReport() {
        ...
        storageRef.putFile(selectedImageUri!!)
            ...
            .addOnSuccessListener { uri ->
                updateReportToFirestore(uri.toString())
            }
            .addOnFailureListener {
    ...
    private fun updateReportToFirestore(imageUrl: String) {
